...
INSERT INTO USER_DATA ("UID", "FirstName", "LastName", "PhotoUrl", "Gender", "PhoneNumber", "CitizenID", "VerifiedFlag", "PaymentDetail_Bank", "PaymentDetail_Account")
VALUES
  ('5dca69ac-36de-4f30-bf02-aab606f48b0f', 'John', 'Doe', 'https://example.com/johndoe.jpg', 'M', '123-456-78930', '1234567890122', true, 'ABC Bank', '123456789'),
  ('5dca69ac-36de-4f30-bf02-aab606f48b10', 'Jane', 'Smith', 'https://example.com/janesmith.jpg', 'F', '987-3654-3210', '9876543210987', true, 'XYZ Bank', '987654321'),
  ('5dca69ac-36de-4f30-bf02-aab606f48b11', 'Alice', 'Johnson', 'https://example.com/alicejohnson.jpg', 'F', '5355-555-5555', '5555555355555', false, 'PQR Bank', '555555555'),
  ('5dca69ac-36de-4f30-bf02-aab606f48b12', 'John', 'Doe', 'https://example.com/johndoe.jpg', 'M', '1323-456-7890', '1234567890121', true, 'ABC Bank', '123456789'),
  ('5dca69ac-36de-4f30-bf02-aab606f48b13', 'Jane', 'Smith', 'https://example.com/janesmith.jpg', 'F', '987-654-3210222', '9876543210984', true, 'XYZ Bank', '987654321'),
  ('5dca69ac-36de-4f30-bf02-aab606f48b14', 'Alice', 'Johnson', 'https://example.com/alicejohnson.jpg', 'F', '555-555-55553', '5555555555555', false, 'PQR Bank', '555555555'),
  ('5dca69ac-36de-4f30-bf02-aab606f48b15', 'John', 'Doe', 'https://example.com/johndoe.jpg', 'M', '123-456-789045', '1234567890123', true, 'ABC Bank', '123456789'),
  ...
  ('5dca69ac-36de-4f30-bf02-aab606f48b17', 'John', 'Doe', 'https://example.com/johndoe.jpg', 'M', '123-456-789022', '1234567890120', true, 'ABC Bank', '123456789');
...
INSERT INTO TRANSACTION_DATA ("UID", "TRANS_ID", "Amount", "Status", "Datetime", "Type", "TaskID")
VALUES
